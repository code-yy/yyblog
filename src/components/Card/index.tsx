  ...
  return (
    <div className="flex justify-center">
      <Link href="https://zenn.dev/yuto76?tab=scraps">
        <a className="flex shadow rounded bg-blue-100 py-8 px-20 my-6 items-center mx-4">
      ...
      <Link href="https://github.com/Utopia300">
        <a className="flex shadow rounded bg-gray-700 py-4 px-20 my-6 items-center mx-4">
      ...
      <Link href="https://twitter.com/yuto_yy_76">
        <a className="flex shadow rounded bg-blue-300 py-8 px-20 my-6 items-center mx-4">
